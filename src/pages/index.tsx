...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`The New Generation of Im v3`}</title>

        <meta
          name="description"
          content="Welcome to The New Generation of Im v3 - Your comprehensive platform for course management, user access, and payment integration. Register, update, and explore courses with ease."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`The New Generation of Im v3`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to The New Generation of Im v3 - Your comprehensive platform for course management, user access, and payment integration. Register, update, and explore courses with ease.`}
            </Text>
            <Box
